...
!function (ht) {
    ...
    }(), bt = "undefined" != typeof MutationObserver, wt = function () {
    ...
    }(), t = /Gecko\//.test(navigator.userAgent), gt = /WebKit\//.test(navigator.userAgent);
    wt || t || gt || (wt = 11);
    var l = function () {
        if (gt) {
        ...
        return !1
    }, mt = !t && !wt, yt = ht(window), Tt = t && window.matchMedia;
    ...
    ht.fn.floatThead = function (t) {
        ...
        if (vt.isFunction(l) && (l = l()), vt.isString(t)) {
            ...
            return this.filter("table").each(function () {
                var t = ht(this), e = t.data("floatThead-lazy");
                e && t.floatThead(e);
        ...
        return this.filter(":not(." + pt.floatTableClass + ")").each(function () {
            ...
            bt = pt.autoReflow && bt;
            var d = m.children("thead:first"), o = m.children("tbody:first");
            ...
            var y, T, n = !0, C = {vertical: 0, horizontal: 0};
            vt.isFunction(St) && (St = St());
            var f = 0;
            !0 === pt.scrollContainer && (pt.scrollContainer = Ct);
            var x = pt.scrollContainer(m) || ht([]), j = 0 < x.length,
                S = j ? ht([]) : pt.responsiveContainer(m) || ht([]), z = $(), I = null;
            ...
            var r = m.find("caption"), L = 1 == r.length;
            ...
            var a = ht("<fthfoot>").css({
                    ...
                    visibility: "hidden"
                }), W = !1, i = ht([]), q = wt <= 9 && !j && I, c = ht("<table/>"), u = ht("<colgroup/>"),
            ...
            var v = ht("<fthtr>").css({
                    ...
                    height: 0,
                    "border-collapse": "collapse"
                }), R = ht("<div>").css(pt.floatContainerCss).attr("aria-hidden", "true"), M = !1, l = ht("<thead/>"),
                b = ht('<tr class="size-row" aria-hidden="true"/>'), w = ht([]), g = ht([]), E = ht([]), k = ht([]);
            ...
            var D = {"table-layout": "fixed"}, F = {"table-layout": m.css("tableLayout") || "auto"},
                O = m[0].style.width || "", N = m.css("minWidth") || "";
            ...
            function Y(t) {
                I != t && (I = t, R.css({position: I ? "absolute" : "fixed"}))
            }
            ...
            function B() {
                ...
                return function () {
                    var t = R.scrollLeft();
                    g = p.find("col");
                    var e, o, n, r, a = (e = m, o = g, n = k, r = wt, mt ? n : r ? pt.getSizingRow(e, o, n) : o);
                    if (a.length == s && 0 < s) {
                        if (!h) for (l = 0; l < s; l++) g.eq(l).css("width", "");
                        P();
                        var i = [];
                        for (l = 0; l < s; l++) i[l] = jt(a.get(l));
                        for (l = 0; l < s; l++) E.eq(l).width(i[l]), g.eq(l).width(i[l]);
                        G()
            ...
            function J() {
                var i, l = x.scrollTop(), s = 0, d = L ? r.outerHeight(!0) : 0, f = H ? d : -d, c = R.height(),
                    u = m.offset(), p = 0, h = 0;
                if (j) {
                    var t = x.offset();
                    s = u.top - t.top + l, L && H && (s += d), p = K("left"), h = K("top"), s -= h
                } else i = u.top - y - c + T + C.horizontal;
                var v = yt.scrollTop(), b = yt.scrollLeft(), w = function () {
                ...
                return function (t) {
                    ...
                    if ("windowScroll" == t) v = yt.scrollTop(), b = yt.scrollLeft(); else if ("containerScroll" == t) if (S.length) {
                        if (!z) return;
                        g = S.scrollLeft()
                    } else l = x.scrollTop(), g = x.scrollLeft(); else "init" != t && (v = yt.scrollTop(), b = yt.scrollLeft(), l = x.scrollTop(), g = w());
                    if (!gt || !(v < 0 || b < 0)) {
            ...
            function Z() {
                ...
                return function (t, e, o) {
                    if (null != t && (i != t.top || l != t.left)) {
                        if (8 === wt) R.css({top: t.top, left: t.left}); else {
                    ...
                    e && function () {
                        var t = zt(m, k, !0), e = z ? S : x, o = e.length ? jt(e[0]) : t,
            ...
            function _() {
                if (x.length) if (pt.support && pt.support.perfectScrollbar && x.data().perfectScrollbar) C = {
                    ...
                    if ("scroll" == x.css("overflow-x")) C.horizontal = St; else {
                        var t = x.width(), e = zt(m, k), o = n < r ? St : 0;
                        C.horizontal = t - o < e ? St : 0
                    }
                    if ("scroll" == x.css("overflow-y")) C.vertical = St; else {
                        var n = x.height(), r = m.height(), a = t < e ? St : 0;
            ...
            if (window.matchMedia && window.matchMedia("print").addListener && !Tt ? (ft = window.matchMedia("print")).addListener(dt) : (yt.on("fth-beforeprint", lt), yt.on("fth-afterprint", st)), j ? I ? x.on(A("scroll"), at) : (x.on(A("scroll"), at), yt.on(A("scroll"), rt)) : (S.on(A("scroll"), at), yt.on(A("scroll"), rt)), yt.on(A("load"), it), function (t, e) {
                if (8 == wt) {
                    var o = yt.width(), n = vt.debounce(function () {
                        var t = yt.width();
                        o != t && (o = t, e())
                    }, 1);
                    yt.on(t, n)
